...
const ProductCard = ({product}) => { 
    ...
    return (
        <div className="w-full flex flex-col items-center h-[350px] relative group">
            ...
            <button className="btn-primary invisible sm:w-fit w-[80%] opacity-70 absolute top-[255px] bg-white text-black border border-solid border-black hover:bg-black hover:text-white hover:border-none group-hover:opacity-80 group-hover:visible">ADD TO CARD</button>
        </div>
    )
}
